...
const CampDetails = () => {
    ...
    return (
        ...
        <div className="bg-blue-100 mb-24">
        ...
        <div className="w-10/12 mx-auto py-24">
            ...
            <p className="text-center my-8"><Link to={`/joinCamp/${_id}`}><button className="btn bg-blue-600 text-white text-xl font-semibold px-20">Join Camp</button></Link></p>
